    ...
    <div className="feedback-player">
      <div className="video-container">
        ...
        <div
          ...
          onClick={togglePlay} onKeyDown={(e) => e.key === 'Enter' && togglePlay}
      ...
      <div className="controls">
        <div className="progress-bar">
          <UnifiedInput type="range"
            min="0"
            max="100"
            value={currentTime / duration * 100 || 0}
            onChange={handleSeek}
            className="seek-slider"  / aria-label="range input">
        ...
        <div className="control-buttons">
          ...
          <div className="right-controls">
            <UnifiedButton onClick={handleAddComment} onKeyDown={(e) => e.key === 'Enter' && handleAddComment} title="현재 시점에 피드백 추가" aria-label="Click">
            ...
            <UnifiedButton onClick={handleScreenshot} onKeyDown={(e) => e.key === 'Enter' && handleScreenshot} title="스크린샷 찍기" aria-label="Click">
              <svg viewBox="0 0 24 24" width="20" height="20">
            ...
            <div className="volume-control" onMouseEnter={() => setShowVolumeSlider(true)} onMouseLeave={() => setShowVolumeSlider(false)}>
              <UnifiedButton
                variant="ghost"
                size="sm"
                onClick={() = aria-label="Click"> setVolume(volume > 0 ? 0 : 1)} onKeyDown={(e) => e.key === 'Enter' && () = aria-label="Click"> setVolume(volume > 0 ? 0 : 1)}>
                <svg viewBox="0 0 24 24" width="20" height="20">
                  {volume === 0 ?
              ...
              <div className={`volume-slider-container ${showVolumeSlider ? 'show' : ''}`}>
                <UnifiedInput type="range"
                  ...
                  className="volume-slider"  / aria-label="range input">
