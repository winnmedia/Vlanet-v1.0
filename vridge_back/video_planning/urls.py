...
urlpatterns = [
    ...
    path('generate/insert-shots/', views.generate_insert_shots, name='generate_insert_shots'),
    ...
    path('export/pdf/<int:planning_id>/', views.export_planning_to_pdf, name='export_planning_to_pdf'),
