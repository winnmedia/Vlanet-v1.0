...
def save_gmail_guide():
    """Gmail 설정 가이드를 파일로 저장"""
    with open('/home/winnmedia/VideoPlanet/vridge_back/GMAIL_SETUP_GUIDE.md', 'w', encoding='utf-8') as f:
        f.write(GMAIL_SETUP_GUIDE)
    print("Gmail 설정 가이드가 GMAIL_SETUP_GUIDE.md 파일로 저장되었습니다.")
