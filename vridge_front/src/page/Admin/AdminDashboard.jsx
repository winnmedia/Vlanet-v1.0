...
import { CommentOutlined, DashboardOutlined, DatabaseOutlined, DeleteOutlined, EditOutlined, ExportOutlined, EyeOutlined, FileTextOutlined, FolderOpenOutlined, InfoCircleOutlined, LineChartOutlined, MailOutlined, PlusOutlined, ProjectOutlined, ReloadOutlined, SearchOutlined, SettingOutlined, TeamOutlined, UserOutlined, UsergroupAddOutlined } from '@ant-design/icons'
                ...
                items={[
                  {
                    ...
                    children: (
                      <>
                        ...
                        {/* 최근 프로젝트 */}
                        <Card title="프로젝트 현황" className="recent-projects" style={{ marginTop: 24 }}>
                          <ProjectDashboard projects={recentProjects} />
                        </Card>
                      </>
                    )
                  },
