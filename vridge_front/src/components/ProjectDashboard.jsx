...
import {
  ...
  CheckCircleOutlined,
  ClockCircleOutlined,
  ExclamationCircleOutlined } from
'@ant-design/icons';
    ...
    <div className="project-dashboard">
      <div className="dashboard-header">
        <div className="stats-grid responsive-grid">
          <UnifiedCard className="stat-card total">
            <div className="stat-value">{stats.total}</div>
            <div className="stat-label">전체 프로젝트</div>
          </UnifiedCard>
          <UnifiedCard className="stat-card active">
            <div className="stat-value">{stats.active}</div>
            <div className="stat-label">진행중</div>
          </UnifiedCard>
          <UnifiedCard className="stat-card delayed">
            <div className="stat-value">{stats.delayed}</div>
            <div className="stat-label">지연</div>
          </UnifiedCard>
          <UnifiedCard className="stat-card completed">
            <div className="stat-value">{stats.completed}</div>
            <div className="stat-label">완료</div>
          </UnifiedCard>
          <UnifiedCard className="stat-card average">
