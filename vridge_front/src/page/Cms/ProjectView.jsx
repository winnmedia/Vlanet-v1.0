      ...
      <PageTemplate>
        ...
        <div className="cms_wrap">
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
            <UnifiedCard variant="default" className="loading-box" style={{ background: 'white', padding: '40px 60px', borderRadius: '16px', boxShadow: '0 20px 60px rgba(0, 0, 0, 0.3)', textAlign: 'center', minWidth: '300px' }}>
              <div className="loading-progress-bar" style={{ width: '100%', height: '6px', background: '#f0f0f0', borderRadius: '3px', overflow: 'hidden', margin: '20px 0' }}>
                <div className="progress-fill" style={{ height: '100%', background: 'linear-gradient(90deg, #1631F8, #0F23C9)', borderRadius: '3px', animation: 'progressAnimation 2s ease-in-out infinite' }}></UnifiedCard>
              </UnifiedCard>
              <div className="loading-text">
                <div className="loading-message" style={{ fontSize: '16px', color: '#333', marginTop: '10px', fontWeight: '500' }}>프로젝트를 불러오는 중...</UnifiedCard>
              </UnifiedCard>
            </UnifiedCard>
          </UnifiedCard>
        </UnifiedCard>
    ...
    <div className="info_wrap">
      <div className="name_box flex align_center space_between">
        ...
        <div className="flex align_center" style={{ gap: '15px' }}>
          ...
          {is_admin &&
          <Button onClick={() = aria-label="Click"> navigate(`/project/${project_id} onKeyDown={(e) => e.key === 'Enter' && () = aria-label="Click"> navigate(`/project/${project_id}/edit`)}
          style={{
      ...
      <UnifiedCard variant="default" className="box" style={boxStyle}>
