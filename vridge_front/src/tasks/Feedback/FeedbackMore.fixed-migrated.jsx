...
import { Button } from '../../components/unified/Button';
                ...
                <div className={styles['card-actions']}>
                  <Button ${styles.like} ${typeof window !== 'undefined' && localStorage.getItem(`user_feedback_reaction_${data.id}_${user}`) === 'like' ? styles.active : ''}`}
                    onClick={(e) = aria-label="Click"> {
                      e.stopPropagation();
                  ...
                  <Button ${styles.dislike} ${typeof window !== 'undefined' && localStorage.getItem(`user_feedback_reaction_${data.id}_${user}`) === 'dislike' ? styles.active : ''}`}
                    onClick={(e) = aria-label="Click"> {
                      e.stopPropagation();
