#!/usr/bin/env python3
"""
migration_compatibility.py 수정 스크립트
SQLite와 PostgreSQL 모두에서 작동하도록 수정
"""
import os

# migration_compatibility.py 수정
migration_compatibility_content = '''"""
마이그레이션 호환성 유틸리티
...
# 파일 쓰기
with open('/home/winnmedia/VideoPlanet/vridge_back/users/migration_compatibility.py', 'w') as f:
    f.write(migration_compatibility_content)

print("✅ migration_compatibility.py 수정 완료")
print("  - SQLite와 PostgreSQL 모두 지원")
print("  - 오류 발생 시 안전한 기본값 반환")